...
* [Product requirements](./PRD.md) - Product, experience, architecture, and release requirements for the overhaul.
* [System audit](./SYSTEM_AUDIT.md) - Current routes, content, interactivity, deployment, and migration risks.
* [Component and motion system](./COMPONENT_AND_MOTION_SYSTEM.md) - Visual foundations and reusable authoring contracts.
* [Phase map](./PHASES.md) - Branch boundaries, purposes, and exit gates.
* [Phase 0 decision](./PHASE_0_DECISION.md) - Accepted direction and the implementation contract for Astro.
