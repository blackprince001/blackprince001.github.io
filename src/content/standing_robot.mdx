---
title: "mjlab and GPU-Accelerated Reinforcement Learning"
...
<VideoPlayer
  id="standing-no-policy"
  src="../robotics/no_policy.mp4"
  title="G1 without a control policy"
  poster="../video-posters/no_policy.mp4.png"
/>
...
<Figure src="../robotics/comp-train-mean.png" alt="Mean Reward Comparison" caption={<><strong>Total Reward:</strong> The Blue line shows steady learning. The Pink line shows the policy collapsing.</>} />
<Figure src="../robotics/comp-reward-standing.png" alt="Upright Reward Comparison" caption={<><strong>Upright Reward:</strong> The specific signal for "keeping the torso vertical."
...
<VideoPlayer
  id="standing-wobbly"
  src="../robotics/wobbly.mp4"
  title="Partially learned wobbly policy"
  poster="../video-posters/wobbly.mp4.png"
/>
...
<Figure src="../robotics/woobly-train.png" alt="Episode Length Dropping" caption={<><strong>Episode Length:</strong> The robot stays alive for shorter periods over time.</>} />
<Figure src="../robotics/loss-woobly.png" alt="Entropy/Loss Dropping" caption={<><strong>Entropy Loss:</strong> The policy is becoming confident in the <em>wrong</em> strategy.
...
<VideoPlayer
  id="standing-stable"
  src="../robotics/standing_policy.mp4"
  title="Stable standing policy"
  poster="../video-posters/standing_policy.mp4.png"
/>
...
<Figure src="../robotics/render.png" alt="Stable Policy" caption={<><strong>Stable Policy:</strong> The robot stays upright for longer periods over time.</>} />
