...
<div className="flex justify-center my-8">
  <img 
    src="../grad/grad-4.png" 
    alt="Irregular cost function landscape"
    className="max-w-full h-auto object-contain rounded-lg shadow-md"
    style={{ height: 'auto' }}
  />
</div>
...
<Example title="Gradient Descent Update Rule">
...
<Example title="Batch Gradient Descent Implementation">
```python
import numpy as np
...
<Example title="Stochastic Gradient Descent Implementation">
```python
n_epochs = 50
t0, t1 = 5, 50
...
<div className="flex justify-center my-8">
  <img 
    src="../grad/grad-6.png" 
    alt="Mini-batch Gradient Descent"
    className="max-w-full h-auto object-contain rounded-lg shadow-md"
    style={{ height: 'auto' }}
  />
</div>
