...
<VideoPlayer
  id="vision-rtdetr"
  src="../traffic-pipeline/rtdetr-l_clip1.mp4"
  title="Raw RT-DETR-l detector output"
  poster="../video-posters/rtdetr-l_clip1.mp4.png"
  caption="Figure 5: raw RT-DETR-l detector output on a representative clip."
/>
...
<VideoPlayer
  id="vision-pipeline"
  src="../traffic-pipeline/pipeline_yolov5l_gru.mp4"
  title="Live pipeline with YOLOv5l and GRU"
  poster="../video-posters/pipeline_yolov5l_gru.mp4.png"
  caption="Figure 9: live pipeline (YOLOv5l + GRU) running end-to-end on a previously-unseen Caltrans stream."
/>
