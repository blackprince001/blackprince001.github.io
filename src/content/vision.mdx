...
<div className="flex justify-center my-10">
  <video controls loop muted playsInline preload="none" poster="../traffic-pipeline/infra.png" className="max-w-2xl w-full rounded-lg shadow-md">
...
<div className="flex justify-center my-10">
  <video controls loop muted playsInline preload="none" poster="../traffic-pipeline/val_pred_best.jpg" className="max-w-2xl w-full rounded-lg shadow-md">
