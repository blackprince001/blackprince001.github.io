---
title: "Building a Competitive AI for Flood-It"
...
You can play against it right here — Q-values for every move are shown live in the right panel:

<div className="my-10">
  <iframe
    src="https://floodit-ai.vercel.app/"
    title="Play Flood-It against the DQN agent"
...
<div className="text-sm text-gray-500 mt-2 text-center italic">
  <strong>Live deployment:</strong> You play the blue corner; the trained DQN plays red. The bar chart on the right shows the Q-values the agent computed for each color choice on its last move — the green-highlighted bar is the action it actually took.
</div>

<Figure src="../rl-filler/imessage.png" alt="System Architecture Diagram" caption={<>46 wins in Filler built brick by brick.</>} />
...
<Figure src="../rl-filler/architecture.png" alt="System Architecture Diagram" caption={<><strong>System Architecture:</strong> The three-layer design separates game logic, RL training, and web interface for modularity and maintainability.</>} />
...
<VideoPlayer
  id="floodit-training"
  src="../rl-filler/training.mp4"
  title="Flood-It training run"
  poster="../video-posters/training.mp4.png"
  caption="Training visualization: the AI learns to capture territory strategically against a random opponent during training."
/>
...
<Figure src="../rl-filler/q-value.png" alt="Q-Value Visualization in Frontend" caption={<><strong>Q-Value Transparency:</strong> The frontend displays Q-values for all actions, showing the AI's evaluation of each color choice. The chosen action (highlighted in green) typically has the highest Q-value among valid options.</>} />
...
<VideoPlayer
  id="floodit-gameplay"
  src="../rl-filler/gameplay.mp4"
  title="Flood-It gameplay demo"
  poster="../video-posters/gameplay.mp4.png"
  caption="Gameplay demo: real-time territory expansion, Q-value visualization, and AI decision-making in action."
/>
...
<Figure src="../rl-filler/reward.png" alt="Episode Reward Graph" />
...
<Figure src="../rl-filler/screenshot.png" alt="Frontend Interface Screenshot" caption={<><strong>User Interface:</strong> The polished dark-mode interface with territory visualization, Q-value displays, and collapsible AI move history.</>} />
...
<VideoPlayer
  id="floodit-ai-vs-human"
  src="../rl-filler/ai.mp4"
  title="Trained AI versus human gameplay"
  poster="../video-posters/ai.mp4.png"
  caption="AI versus human gameplay: a complete game showing the trained AI competing against a human player."
/>
