...
<div className="flex justify-center my-8">
  <img 
    ...
    src="../pca/pca-initial.png" 
    alt="PCA initial data"
    style={{ height: 'auto' }}
  />
</div>
...
<div className="flex justify-center my-8">
  <img 
    className="max-w-full h-auto object-contain rounded-lg shadow-md" 
    src="../pca/pca-final.png" 
    alt="PCA final projection"
    style={{ height: 'auto' }}
  />
</div>
...
<Example title="Variance Preservation in 3D to 2D">
For instance:
...
<div className="flex justify-center my-8">
  <img 
    className="max-w-full h-auto object-contain rounded-lg shadow-md" 
    src="../pca/pca-preserve.png" 
    alt="PCA variance preservation"
    style={{ height: 'auto' }}
  />
</div>
...
<Example title="MNIST Compression and Reconstruction">
...
It is also possible to decompress the reduced dataset back to 784 dimensions by applying the inverse transformation of the PCA projection. This will not give you back the original data, since the projection lost a bit of information, but it will likely be close to the original data.
</Example>
<AutoNumberedSidenote>Image reference from <a href="https://www.oreilly.com/library/view/hands-on-machine-learning/9781098125967/">Hands On Machine Learning Book by Aurélien Géron</a></AutoNumberedSidenote>
<div className="flex justify-center my-8">
  <img 
    className="max-w-full h-auto object-contain rounded-lg shadow-md" 
    src="../pca/pca-compression.png" 
    alt="PCA compression example"
    style={{ height: 'auto' }}
  />
</div>
