...
<VideoPlayer
  id="design2robot-guide"
  src="../robotics/motion.webm"
  title="CAD to simulation visual guide"
  poster="../video-posters/video-placeholder.svg"
  caption="Visual guide: from static CAD models to dynamic, simulatable robots."
/>
...
CAD Design Design the robot in Fusion 360, ensuring the orientation is set up correctly (x-axis forward, y-axis to the side, and z-axis up) so the robot moves as expected. The design process involves:
    ...
    *   Designing and positioning the wheels.
    <Figure srcs={["../robotics/wheels.png", "../robotics/wheels-2.png"]} />
