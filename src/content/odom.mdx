...
<BlogSuggestion link="https://github.com/blackprince001/ros_tt_kontroller_diff_drive" title="I implemented Odometry for ROS here using the concepts highlight above. Take a look and don't forget to leave a star." />
