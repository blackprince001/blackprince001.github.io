...
<VideoPlayer
  id="traffic-idm"
  src="../atscs/idm-sim.mp4"
  title="IDM vehicle dynamics simulation"
  poster="../video-posters/idm-sim.mp4.png"
  caption="Figure 1: Vehicle dynamics. Note the accordion effect as cars decelerate."
/>
...
<Figure src="../atscs/policy.png" alt="Reward Components over Time" caption={<><strong>Figure 2: Reward Component Analysis (Scenario A).</strong> Notice how the Fairness penalty spikes early in training but forces the policy to stabilize, eventually leading to a higher Total Reward.</>} />
...
<VideoPlayer
  id="traffic-scenario-a"
  src="../atscs/scenario-a.mp4"
  title="Single-node platooning"
  poster="../video-posters/scenario-a.mp4.png"
  caption="Figure 3: model behaviour under the heavy traffic evaluation run."
/>
...
<VideoPlayer
  id="traffic-scenario-b"
  src="../atscs/scenario-b.mp4"
  title="Arterial coordination green wave"
  poster="../video-posters/scenario-b.mp4.png"
  caption="Figure 4: emergent coordination across two intersections."
/>
...
<Figure
  srcs={["../atscs/flow.png", "../atscs/image.png"]}
  cols={2}
  alt="Traffic throughput and flow analysis"
/>

<VideoPlayer
  id="traffic-scenario-c"
  src="../atscs/scenario-c.mp4"
  title="Gating behaviour in moderating traffic"
  poster="../video-posters/scenario-c.mp4.png"
  caption="Figure 5: gating behaviour exhibited by the model in moderating traffic."
/>
