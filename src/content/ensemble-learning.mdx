...
<Example title="Ensemble of Binary Classifiers">
Suppose you build an ensemble containing 1,000 classifiers that are each correct only 51% of the time (barely better than random guessing). If you predict the majority class, you can hope for up to 75% accuracy! However, this is only true if all classifiers are perfectly independent, making uncorrelated errors, which is clearly not the case since they are trained on the same data. They are likely to make the same types of errors, so there will be many majority votes for the wrong class, reducing the ensemble’s accuracy.
</Example>
...
<Figure src="../ml-book-assets/Screenshot 2024-12-01 at 4.53.32 PM.png" alt="Voting classifier combining multiple base models" caption={<><strong>Voting Classifier:</strong> Multiple base models make predictions, and the ensemble selects the class with the majority of votes.</>} />
...
<Figure src="../ml-book-assets/Screenshot 2024-12-01 at 4.54.38 PM.png" alt="Bagging and pasting ensemble methods" caption={<><strong>Bagging and Pasting:</strong> Training multiple models on different subsets of data to create diversity and reduce variance.</>} />
...
<Figure src="../ml-book-assets/Screenshot 2024-12-01 at 4.57.25 PM.png" alt="Feature importance in Random Forests" caption={<><strong>Feature Importance:</strong> Random Forests can assess the relative importance of features based on how much they reduce impurity across all trees.</>} />
...
<Figure src="../ml-book-assets/Screenshot 2024-12-01 at 4.58.41 PM.png" alt="AdaBoost sequential training process" caption={<><strong>AdaBoost Training:</strong> Sequential training process showing how instance weights are updated to focus on misclassified examples.</>} />

<Figure src="../ml-book-assets/Screenshot 2024-12-01 at 4.59.26 PM.png" alt="AdaBoost decision boundaries" caption={<><strong>AdaBoost Decision Boundaries:</strong> How consecutive learners progressively focus on harder instances, improving the ensemble's accuracy.</>} />
...
<Figure src="../ml-book-assets/Screenshot 2024-12-01 at 4.37.48 PM.png" alt="Gradient Boosting algorithm overview" caption={<><strong>Gradient Boosting Algorithm:</strong> Overview of the iterative process for building a gradient boosted ensemble.</>} />
...
<Figure src="../ml-book-assets/Screenshot 2024-12-01 at 5.00.46 PM.png" alt="Gradient Tree Boosting for regression" caption={<><strong>Gradient Tree Boosting:</strong> Visualization showing how each tree fits the residual errors of the previous ensemble, progressively improving predictions.</>} />
...
<Figure src="../ml-book-assets/Screenshot 2024-12-01 at 5.04.28 PM.png" alt="Stacking ensemble method architecture" caption={<><strong>Stacking Architecture:</strong> A meta-learner (blender) learns to optimally combine predictions from multiple base models.</>} />
...
<Figure src="../ml-book-assets/Screenshot 2024-12-01 at 5.05.03 PM.png" alt="Training the blender model in stacking" caption={<><strong>Training the Blender:</strong> The meta-learner is trained on predictions from base models to learn optimal combination weights.</>} />
...
<Figure src="../ml-book-assets/Screenshot 2024-12-01 at 5.05.20 PM.png" alt="Multilayer stacking architecture" caption={<><strong>Multilayer Stacking:</strong> Multiple layers of blenders can potentially improve performance but increase complexity.</>} />
